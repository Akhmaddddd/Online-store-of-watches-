# Generated by Django 4.2.7 on 2023-11-01 13:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='products', to='store.category', verbose_name='Продукт')),
            ],
            options={
                'verbose_name': 'Товар',
